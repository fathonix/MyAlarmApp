...
class AlarmReceiver : BroadcastReceiver() {
    ...
    override fun onReceive(context: Context, intent: Intent) {
        ...
        val notifId = if (type == TYPE_ONE_TIME) ID_ONE_TIME else ID_REPEATING
    ...
    fun setOneTimeAlarm(context: Context, type: Int, date: String, time: String, message: String) {
        ...
        // Log.d("DateArray",dateArray.toList().toString())
        // Log.d("TimeArray",timeArray.toList().toString())
